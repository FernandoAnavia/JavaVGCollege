...
public class Attendance extends javax.swing.JFrame {
    ...
    private void fillComboGroups(){
        ...
        try {
         ...
         String sqlDays = "DESCRIBE vgccollege.Attendance" + LoginSesion.currentGroup;
    ...
    private void initComponents() {
        ...
        StatusCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Present", "Absent" }));
        ...
        // TODO add your handling code here:
            ...
            while (rs.next()){
                ...
                try {
                    ...
                    String sqlCreateT = "CREATE TABLE IF NOT EXISTS Attendance" + newFullDesc + "(\n" +
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try (Connection conn = MySQLConnection.getConnection()){
            ...
            String sql = "SELECT * from attendance" + LoginSesion.currentGroup;
    ...
    private void CReateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CReateBtnActionPerformed
        ...
        if ((StatusCombo.getSelectedItem().toString())=="Present"){
            AttVal = 1;
        }
        ...
        try (Connection conn = MySQLConnection.getConnection()){
            ...
            String mySQLQuery =
            "INSERT INTO vgccollege.Attendance" + LoginSesion.currentGroup + "(LecturerId, StudentId, CourseId, SemesterId, " + column + " ) "
            + "VALUES (?,?,?,?,?)";
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        try (Connection conn = MySQLConnection.getConnection()){
                ...
                String mySQLQuery = 
                    "UPDATE vgccollege.Attendance" + LoginSesion.currentGroup + " SET " + column + " = ? WHERE LecturerId=? and StudentId=? and CourseId = ? and SemesterId = ?";                        
            ...
            pst.executeUpdate();
                ...
                if(i>0){
                    JOptionPane.showMessageDialog(null, "Attendace updated successful");
                } else {
                    JOptionPane.showMessageDialog(null, "Attendance could not be made");
                }
        ...
        try {
         ...
         String sqlDays = "DESCRIBE vgccollege.Attendance" + LoginSesion.currentGroup;
            ...
            while (rsDays.next()){
                ...
                String avSum0 = "update vgccollege.Attendance" + LoginSesion.currentGroup + " set Average = 0";
                ...
                String avSum = "update vgccollege.Attendance" + LoginSesion.currentGroup + " set Average = Average + Class" + d;
                ...
                String avFinal = "update vgccollege.Attendance" + LoginSesion.currentGroup + " set Average = Average/" + d + "*100";
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        int confirmation = JOptionPane.showConfirmDialog(null, "You are about to create a class, this class cannot be deleted in the future. Do you want to proceed?","Warning", JOptionPane.YES_NO_OPTION);
        ...
        try (Connection conn = MySQLConnection.getConnection()){
                ...
                String mySQLQuery = 
                    "ALTER TABLE vgccollege.Attendance" + LoginSesion.currentGroup + " ADD COLUMN Class" + comboSize + " int(1)";                        
            ...
            pst.executeUpdate();
                   ...
                   JOptionPane.showMessageDialog(null, "Class was created successfully");
            ...
            JOptionPane.showMessageDialog(null, "The class wasn't created");
        }
